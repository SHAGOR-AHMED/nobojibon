...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-edit"></i>Add Album Image</h2>
            <h3>
                <?php
        ...
        <div class="box-content">
            <form class="form-horizontal" action="<?php echo base_url('Gallery/save_galleryImage');?>" method="post" enctype="multipart/form-data">
                <fieldset>
                    <legend></legend>
