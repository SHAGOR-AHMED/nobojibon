										...
										<div class="widget-main">
											...
											<form name="login_panel" id="login_panel" action="<?= base_url('Admin/admin_login_check'); ?>" method="post">
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" name="admin_email" id="admin_email" value="" placeholder="Admin Email" required="" />
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" class="form-control" name="admin_pass" id="password" value="" placeholder="Password" required="" />
